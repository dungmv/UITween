...
public class TweenTransform : UITweener
{
	...
	protected override void OnUpdate (float factor, bool isFinished)
	{
		if (to != null)
		{
			if (mTrans == null)
			{
                mTrans = (RectTransform)transform;
    ...
    static public TweenTransform Begin(GameObject go, float duration, RectTransform to) { return Begin(go, duration, null, to); }

	/// <summary>
	/// Start the tweening operation.
	/// </summary>

    static public TweenTransform Begin(GameObject go, float duration, RectTransform from, RectTransform to)
	{
