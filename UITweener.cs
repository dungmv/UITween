...
public abstract class UITweener : MonoBehaviour
{
	...
	/// </summary>
    [Serializable]
    public class TweenerEvent : UnityEvent { }
    // Event delegates triggered on finish.
    [FormerlySerializedAs("onFinished")]
    [SerializeField]
    private TweenerEvent m_OnFinished = new TweenerEvent();
    public TweenerEvent onFinished
    {
        get { return m_OnFinished; }
        set { m_OnFinished = value; }
    }
